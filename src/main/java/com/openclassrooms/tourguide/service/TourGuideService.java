...
public class TourGuideService {
    ...
    public List<AttractionDTO> getNearbyAttractions(VisitedLocation visitedLocation) {
        ...
        // Sort attractions by distance from the user's location
        List<Attraction> sortedAttractions = attractions.stream()
                .sorted((a1, a2) -> {
                    double dist1 = rewardsService.getDistance(new Location(a1.latitude, a1.longitude), userLocation);
                    double dist2 = rewardsService.getDistance(new Location(a2.latitude, a2.longitude), userLocation);
        ...
        for (Attraction attraction : sortedAttractions) {
            ...
            attractionDTOs.add(new AttractionDTO(
                    ...
                    attractionLocation,
                    userLocation,
                    rewardsService.getDistance(attractionLocation, userLocation),
